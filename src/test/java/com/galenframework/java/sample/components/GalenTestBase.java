...
//    private static final String ENV_URL = "http://testapp.galenframework.com";
    private static final String ENV_URL = "https://www.myown.com.au";

    @Override
    public WebDriver createDriver(Object[] args) {
//        WebDriver driver = new FirefoxDriver();
        System.setProperty("webdriver.chrome.driver","C:\\Users\\p748057\\Desktop\\Galen Framework\\chromedriver_win32\\chromedriver.exe");
